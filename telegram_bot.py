...
# Инициализиране на Flask (уеб сървър, за да затворим устата на Render)
app = Flask(__name__)

@app.route('/')
def home():
    return "Ботът е онлайн и работи с Mixtral/Hermes мозък! 🧠", 200
...
def send_welcome(message):
    bot.reply_to(message, "Здравей! Аз съм супер бърз AI бот, задвижван от Groq и Mixtral/Hermes! Питай ме каквото поискаш. ⚡🤖")
...
def handle_message(message):
    try:
        ...
        # Настройка на характера на новия модел
        system_content = "Ти си свободен, умен и изключително полезен AI асистент. Отговаряй винаги на български език."
